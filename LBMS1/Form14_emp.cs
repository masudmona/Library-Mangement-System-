...
namespace LBMS1
{
    public partial class Form14_emp : Form
    {
        ...
        private void Form14_emp_Load(object sender, EventArgs e)
        {
        ...
        private void button_save_Click(object sender, EventArgs e)
        {
            try
            {
                string query = @"INSERT INTO Employee(          Name,                   Department,                       Contact,                         Email)" +
                                "VALUES(        '" + textBox_name.Text + "', '" + comboBox_dept.Text + "', '" + textBox_contact.Text + "', '" + textBox_email.Text + "' ) ";
